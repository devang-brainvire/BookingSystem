						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								<li class="active">
									...
									<?php
                						for($i=0; $i < sizeof($fetchCity);$i++){


             						?> 
									<option><?php echo $city_name[$i]; ?></option>
									<?php
									}
				...
				{	
 				?>
					<div class="col-md-4 col-sm-4 fh5co-item-wrap">
							...
							<img src='Admin/<?php echo $movie_img[$i]; ?>' alt="Free HTML5 Bootstrap Template by FreeHTML5.co" class="img-responsive" style="height: 	">
